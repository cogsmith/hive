...
App.Load = function (cell) {
	...
	let cmd88 = "docker stop ZXWEB_" + App.Hive + " ; docker rm ZXWEB_" + App.Hive + " ; docker run -t --name ZXWEB_" + App.Hive + ' --env HIVESLUG=' + slug + ' --env SLUGHOST=' + slughost.toLowerCase() + " -p " + App.HiveBind + ":80:88 -v " + App.HivePath + "/" + App.Hive + ":/webhost cogsmith/wx-static --loglevel trace --port 9 --ip 0.0.0.0 --www /webhost --base / --vhost";
	console.log(cmd88);
