...
App.Load = function (cell) {
	...
	let cmd = "docker stop ZXPROXY_"+App.Hive+" ; docker rm ZXPROXY_"+App.Hive+" ; docker run --rm --name ZXPROXY_"+App.Hive+" -p "+App.HiveBind+":80:80 -p "+App.HiveBind+":443:443 -v "+App.HivePath+"/"+App.Hive+":/hive cogsmith/zx-proxy "+adminips+" --hiveip "+App.HiveIP+" --hivebind "+App.HiveBind+" --hivepath /hive --toip "+App.HiveBind+' --appinfo --loglevel trace';
	console.log(cmd);
